...
CONVERT_TO_NONLOOP = {
    ...
    "17": [
        ...
        55000500146043,
        55000500199027,
        # fix flowlines on Henry's Fork of Snake River (due to issues reported by user to Kat on 7/20/2026)
        55001200075006,
        55001200042873,
        55001200122721,
        55001200122639,
...
CONVERT_TO_LOOP = {
    ...
    "17": [
        ...
        55000300287268,
        # fixes corresponding to Henry's Fork of Snake River (above)
        55001200090780,
        55001200080371,
        55001200010376,
        55001200089942,
