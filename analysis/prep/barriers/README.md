...
Dams, surveyed road-related barriers, and waterfalls are downloaded from ArcGIS Online using `analysis/prep/barriers/download.py`. This requires AGOL tokens to be set properly (below).
