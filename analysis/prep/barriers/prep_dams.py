...
### Snap to NHD dams
df, to_snap = snap_to_nhd_dams(df, to_snap, tolerance=SNAP_TOLERANCE)

### Snap to waterbodies
df, to_snap = snap_to_waterbodies(df, to_snap, tolerance=SNAP_TOLERANCE)

### Snap to flowlines
df, to_snap = snap_to_flowlines(df, to_snap, tolerance=SNAP_TOLERANCE)
