...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/mask.json $DATADIR/region_mask.gpkg -progress
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSONSeq $TMPDIR/HUC6.json $DATADIR/huc6.gpkg -progress
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSONSeq $TMPDIR/HUC8.json $DATADIR/huc8_priorities.gpkg -progress
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSONSeq $TMPDIR/HUC12.json $DATADIR/huc12.gpkg -progress
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSONSeq $TMPDIR/ECO3.json $DATADIR/region_eco3.gpkg -progress
tippecanoe -f -z 10 -l ECO3 -pg -o $TILEDIR/ECO3.mbtiles  -T id:string $TMPDIR/ECO3.json
rm $TMPDIR/ECO3.json

echo "Generating Ecoregion Level 4 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSONSeq $TMPDIR/ECO4.json $DATADIR/region_eco4.gpkg -progress
