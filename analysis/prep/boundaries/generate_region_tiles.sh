...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/boundary.json $DATADIR/region_boundary.gpkg
tippecanoe -f -z 8 -l boundary -pg -o $TILEDIR/boundary.mbtiles $TMPDIR/boundary.json
rm $TMPDIR/boundary.json

ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/mask.json $DATADIR/region_mask.gpkg
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/states.json $DATADIR/region_states.gpkg
tippecanoe -f -z 8 -l State -pg -o $TILEDIR/states.mbtiles $TMPDIR/states.json
rm $TMPDIR/states.json

echo "Generating county tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/counties.json $DATADIR/region_counties.gpkg
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/ECO3.json $DATADIR/region_eco3.gpkg
tippecanoe -f -z 10 -l ECO3 -pg -o $TILEDIR/ECO3.mbtiles  -T id:string $TMPDIR/ECO3.json
rm $TMPDIR/ECO3.json

echo "Generating Ecoregion Level 4 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/ECO4.json $DATADIR/region_eco4.gpkg
