...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/boundary.json $DATADIR/sarp_boundary.gpkg
tippecanoe -f -z 8 -l boundary -pg -o $TILEDIR/boundary.mbtiles $TMPDIR/boundary.json
rm $TMPDIR/boundary.json

ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/mask.json $DATADIR/sarp_mask.gpkg
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/HUC6.json $DATADIR/sarp_huc6.gpkg
tippecanoe -f -z 8 -l HUC6 -pg -o $TILEDIR/HUC6.mbtiles  -T id:string $TMPDIR/HUC6.json
rm $TMPDIR/HUC6.json

# HUC8
echo "Generating HUC8 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/HUC8.json $DATADIR/sarp_huc8.gpkg
tippecanoe -f -z 10 -l HUC8 -pg -o $TILEDIR/HUC8.mbtiles  -T id:string $TMPDIR/HUC8.json
rm $TMPDIR/HUC8.json

# HUC12
echo "Generating HUC12 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/HUC12.json $DATADIR/sarp_huc12.gpkg
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/states.json $DATADIR/sarp_states.gpkg
tippecanoe -f -z 8 -l State -pg -o $TILEDIR/states.mbtiles $TMPDIR/states.json
rm $TMPDIR/states.json

echo "Generating county tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/counties.json $DATADIR/sarp_counties.gpkg
...
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/ECO3.json $DATADIR/sarp_eco3.gpkg
tippecanoe -f -z 10 -l ECO3 -pg -o $TILEDIR/ECO3.mbtiles  -T id:string $TMPDIR/ECO3.json
rm $TMPDIR/ECO3.json

echo "Generating Ecoregion Level 4 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/ECO4.json $DATADIR/sarp_eco4.gpkg
