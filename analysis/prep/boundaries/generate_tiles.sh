...
tippecanoe -f -z 8 -l boundary -o $TILEDIR/boundary.mbtiles $TMPDIR/boundary.json
rm $TMPDIR/boundary.json

ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/mask.json $DATADIR/sarp_mask.shp
tippecanoe -z 8 -l mask -o $TILEDIR/mask.mbtiles $TMPDIR/mask.json
rm $TMPDIR/mask.json
...
tippecanoe -f -Z 6 -z 12 -l HUC12 -o $TILEDIR/HUC12.mbtiles  -T id:string $TMPDIR/HUC12.json
...
tippecanoe -f -z 8 -l State -o $TILEDIR/states.mbtiles $TMPDIR/states.json
...
tippecanoe -f -Z 3 -z 12 -l County -o $TILEDIR/counties.mbtiles $TMPDIR/counties.json
...
tippecanoe -f -z 10 -l ECO3 -o $TILEDIR/ECO3.mbtiles  -T id:string $TMPDIR/ECO3.json
rm $TMPDIR/ECO3.json

echo "Generating Ecoregion Level 4 tiles..."
ogr2ogr -t_srs EPSG:4326 -f GeoJSON $TMPDIR/ECO4.json $DATADIR/eco4_prj.shp
tippecanoe -f -Z 3 -z 12 -l ECO4 -o $TILEDIR/ECO4.mbtiles  -T id:string $TMPDIR/ECO4.json
rm $TMPDIR/ECO4.json
