...
tippecanoe -f -Z5 -z12 -B6 -pk -pg -pe -ai -o $WORKDIR/dams_with_networks.mbtiles -l dams -T sarpid:string -T name:string -T river:string -T protectedland:bool -T County:string -T HUC6:string -T HUC8:string -T HUC12:string $WORKDIR/dams_with_networks.csv
tippecanoe -f -Z9 -z12 -B10 -pk -pg -pe -ai -o$WORKDIR/dams_without_networks.mbtiles -l background -T sarpid:string  -T name:string -T river:string -T protectedland:bool $WORKDIR/dams_without_networks.csv
