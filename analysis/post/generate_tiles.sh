...
tippecanoe -f -Z5 -z14 -B6 -pk -pg -pe -ai -o $WORKDIR/barriers_with_networks.mbtiles -l barriers -T name:string -T stream:string -T road:string -T sarpid:string -T localid:string -T crossingcode:string -T source:string -T stream:string -T road:string -T roadtype:string -T crossingtype:string -T condition:string -T potentialproject:string -T County:string -T HUC6:string -T HUC8:string -T HUC12:string $WORKDIR/barriers_with_networks.csv
