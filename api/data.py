...
try:
    ...
    combined_barriers = dataset(
        data_dir / "combined_barriers.feather", format="feather"
    )
    largefish_barriers = dataset(
        data_dir / "largefish_barriers.feather", format="feather"
    )
    smallfish_barriers = dataset(
        data_dir / "smallfish_barriers.feather", format="feather"
    )
