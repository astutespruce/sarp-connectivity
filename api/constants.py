...
FIELD_DEFINITIONS = {
    ...
    # mainstem upstream network
    "TotalUpstreamMainstemMiles": "number of miles in the upstream mainstem river network from this {type}, including miles in waterbodies.  Mainstems are defined as having >= 1 square mile drainage area, greater than Strahler stream order 1, and the same stream order as the reach where the dam is located. -1 = not available.",
