...
FIELD_DEFINITIONS = {
    ...
    "UpstreamResilientMiles": "number of miles in the upstream river network from this {type} that are within subwatersheds identified by The Nature Conservancy with above average or greater freshwater resilience (v0.44), including miles in waterbodies.  -1 = not available.  See https://www.maps.tnc.org/resilientrivers/#/explore for more information.",
    "PercentResilient": "percent of the the upstream river network length from this {type} that is within subwatersheds identified by The Nature Conservancy with above average or greater freshwater resilience (v0.44), including miles in waterbodies.  -1 = not available.  See https://www.maps.tnc.org/resilientrivers/#/explore for more information.",
    ...
    "DownstreamResilientMiles": "number of free-flowing miles in the downstream river network length from this {type} that is within subwatersheds identified by The Nature Conservancy with above average or greater freshwater resilience (v0.44).  Excludes miles in altered waterbodies.  -1 = not available.  See https://www.maps.tnc.org/resilientrivers/#/explore for more information.",
