...
FIELD_DEFINITIONS = {
    ...
    "FreeAlteredDownstreamMiles": "number of free-flowing altered miles in the downstream river network from this {type}.  Excludes miles in waterbodies or segments specifically coded by NHD as canals or ditches. -1 = not available.",
    "FreeUnalteredDownstreamMiles": "number of free-flowing altered miles in the downstream river network from this {type}.  Limited to segments specifically coded by NHD as canals or ditches.  Excludes miles in waterbodies. -1 = not available.",
