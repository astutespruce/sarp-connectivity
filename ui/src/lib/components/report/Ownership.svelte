			...
			{#if costmean > 0}
				<div>
					...
					<div class="text-xs text-muted-foreground mt-2 leading-tight">
						...
						USD and should be appropriately adjusted for current inflation. Estimates reflect the
						mean modeled cost with 50% prediction ranges, and may be less reliable for structures
						exceeding 5 m in height due to limited data. Costs related to stakeholder consultations
						or litigation, if any, are not included in this model.
					</div>
				</div>
			{/if}
		</div>
