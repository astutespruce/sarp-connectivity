...
export const roadCrossingsLayer = {
	...
	paint: {
		'circle-color': getHighlightExpr(pointColors.offNetwork.color, pointColors.highlight.color),
		'circle-stroke-color': getHighlightExpr(
...
export const rankedPointLayer = {
	...
	paint: {
		...
		'circle-radius': [
			...
			['zoom'],
			9,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.5, 1], 9),
			10,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 1, 2], 10),
			12,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 2, 3], 12),
			14,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 3, 4], 14),
			16,
...
export const unrankedPointLayer = {
	...
	paint: {
		...
		'circle-opacity': ['interpolate', ['linear'], ['zoom'], 12, getHighlightExpr(0.5, 1), 14, 1],
