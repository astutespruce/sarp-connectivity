...
export const getTierPointSize = (scenario: string, tierThreshold: number) => [
	'interpolate',
	['linear'],
	['zoom'],
	3,
	...
	paint: {
		...
		'circle-radius':
			...
			[
				...
				['zoom'],
				3,
				getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.25, 0.5], 2),
				5,
				getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 1.5, 2], 5),
				14,
...
export const excludedPointLayer = {
	...
	paint: {
		...
		'circle-radius': [
			...
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.25, 0.5], 2),
			5,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.5, 1], 5),
			9,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 1, 2], 10),
			14,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 4, 6], 14)
		],
		'circle-opacity': ['interpolate', ['linear'], ['zoom'], 10, getHighlightExpr(0.5, 1), 12, 1],
		'circle-stroke-width': {
			stops: [
				[10, 0],
				[11, 0.25],
...
export const unrankedPointLayer = {
	...
	paint: {
		...
		'circle-radius': [
			...
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.25, 0.5], 2),
			14,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 2.5, 4], 14)
		],
		'circle-opacity': 1,
		'circle-stroke-width': {
			stops: [
...
export const removedBarrierPointLayer = {
	...
	paint: {
		...
		'circle-opacity': [
			...
			['zoom'],
			10,
			getHighlightExpr(['match', ['get', 'barriertype'], 'small_barriers', 0.25, 0.5], 1),
			14,
			1
		],
		'circle-stroke-width': {
...
export const roadCrossingsLayer = {
	...
	paint: {
		'circle-color': getHighlightExpr(pointColors.roadCrossings.color, pointColors.highlight.color),
		'circle-stroke-color': getHighlightExpr(
		...
		'circle-opacity': ['interpolate', ['linear'], ['zoom'], 10, getHighlightExpr(0.5, 1), 14, 1],
		'circle-stroke-width': {
			stops: [
				[10, 0],
				[14, 1]
...
export const damsSecondaryLayer = {
	...
	maxzoom: 24,
	paint: {
		'circle-color': getHighlightExpr(pointColors.damsSecondary.color, pointColors.highlight.color),
		'circle-stroke-color': getHighlightExpr(
...
export const waterfallsLayer = {
	...
	maxzoom: 24,
	paint: {
		'circle-color': getHighlightExpr(pointColors.waterfalls.color, pointColors.highlight.color),
		'circle-stroke-color': getHighlightExpr(
