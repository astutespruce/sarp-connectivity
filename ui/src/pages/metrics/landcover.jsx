...
const LandcoverPage = ({ data: { headerImage } }) => (
  <Layout>
    ...
    <PageContainer>
      ...
      <LargeText>Rivers and streams that have a greater amount of natural landcover in their floodplain are more
                        ...
                        altered and have impaired water quality.</LargeText>
...
export const pageQuery = graphql`
  query NaturalLandcoverQuery {
    headerImage: file(
      relativePath: { eq: "6882770647_c43a945282_o.jpg" }
    ) {
      childImageSharp {
        fluid(maxWidth: 3200) {
