    ...
    <Box sx={sx}>
      ...
      >
        ...
        {totalupstreammiles > 0 ? (
          <Box>
            <b>{formatPercent(percentUnaltered)}% of the upstream network</b> is
            in unaltered stream reaches.
          </Box>
        ) : null}
      ...
      <Box sx={{ mt: '3rem' }}>
        ...
        >
          ...
          <Row>
            <Box>Coldwater habitat miles</Box>
      ...
      <Box sx={{ mt: '2rem' }}>
        ...
        <b>{formatNumber(unalteredwaterbodyacres)} acres</b> of unaltered lakes
        and ponds and <b>{formatNumber(unalteredwetlandacres)} acres</b> of
      ...
      <Paragraph variant="help" sx={{ mt: '2rem', fontSize: 0 }}>
        ...
        dataset (v0.44). Coldwater habitat miles are the total length of stream
        reaches that are within watersheds with slighly above average or greater
        cold temperature scores (TNC, March 2024).
        <br />
        <br />
