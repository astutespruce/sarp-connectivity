      ...
      <View style={{ marginTop: 36 }}>
        ...
        <Text style={{ color: '#7f8a93', marginTop: 28, fontSize: 10 }}>
          ...
          {networkType === 'smallfish_barriers'
            ...
            : null}
          {removed
            ? `, including any that were present at the time this ${barrierTypeLabel} was removed, except for any barriers directly upstream that were removed in the same year as this barrier. All barriers removed prior to 2000 or where the year they were removed was unknown were lumped together for this analysis`
            : null}
