      ...
      >
        ...
        {barrierType === 'small_barriers' ? (
          <Paragraph variant="help" sx={{ mt: '3rem' }}>
            ...
            {pluralize('road-related barrier', totalSmallBarriers)}, and
            available information on barriers that have been or are actively
            being removed or mitigated, including projects starting in 2024.
            Because the inventory is incomplete in many areas, areas with a high
            number of road-related barriers may simply represent areas that have
        ...
        {barrierType === 'combined_barriers' ? (
          <Paragraph variant="help" sx={{ mt: '3rem' }}>
            ...
            <b>{formatNumber(totalSmallBarriers, 0)}</b> inventoried{' '}
            {pluralize('road-related barrier', totalSmallBarriers)}, and
            available information on dams and barriers that have been or are
            actively being removed or mitigated, including projects starting in
            2024. Because the inventory is incomplete in many areas, areas with
            a high number of dams or road-related barriers may simply represent
